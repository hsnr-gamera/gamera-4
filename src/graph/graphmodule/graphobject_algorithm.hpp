...
#define SHORTEST_PATH_METHODS \
      {  "dijkstra_shortest_path", graph_dijkstra_shortest_path, METH_O, \
...
{  "shortest_path", graph_dijkstra_shortest_path, METH_O, \
...
#define COLOR_METHODS \
  {  "colorize", graph_colorize, METH_O, \
     "**colorize** (*ncolors*)\n\n" \
  ...
  {  "get_color", graph_get_color, METH_O, \
