...
TIFFReadDirEntryArray(TIFF *tif, TIFFDirEntry *direntry, uint32 *count, uint32 desttypesize, void **value);
...
TIFFCheckDirOffset(TIFF *tif, uint64 diroff) {
	...
	if (tif->tif_dirlist == nullptr || tif->tif_dirnumber > tif->tif_dirlistsize) {
		uint64 *new_dirlist;
