...
class DocumentationGenerator:
    def __init__(self, root_path=".", test_mode=False, classes=[], plugins=None, sourceforge_logo=False,
                 contact_url="http://gamera.informatik.hsnr.de/contact.html"):
...
def gendoc(classes=[], plugins=None, sourceforge_logo=False,
           contact_url="http://gamera.informatik.hsnr.de/contact.html"):
    print_usage()
    ...
    try:
        docgen = DocumentationGenerator(root, test_mode, classes=classes, plugins=plugins,
                                        sourceforge_logo=sourceforge_logo, contact_url=contact_url)
    except Exception as e:
